                    ...
                    <div className=' animate-fade'>
                        ...
                        <div className=' bg-purple-400 rounded-lg mt-20 p-4 max-w-[500px]'>
                            ...
                            <div className=' text-left'>
                                ...
                                {/* <p>Compared to other mental health apps, we don't ask you to do dumb shit like imagine your perfect beach getaway or read about meditation techniques you'll never do. In here, U just press like 2 buttons</p> */}
