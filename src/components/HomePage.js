...
export function HomePage ({ darkMode, graphRef }) {
  ...
  <link rel="shortcut icon" href="/a.png" />
        ...
        <div onClick={() => setAbout(true)} className={about || destroyer ? 'hidden' : 'mt-16 flex justify-center items-center gap-2 text-zinc-500 hover:cursor-pointer hover:text-zinc-200'}>
          <div>
