                    ...
                    return (
                        ...
                        ' key={index}>
                            ...
                            >
                                ...
                                <span className={!destroyer ? ' w-[32px] flex justify-center items-center absolute top-0 translate-y-1/2 md:right-0 -translate-x-1/2 max-md:mt-3 max-md:ml-1 md:-mt-[5px]' : 'hidden'}>
